...
function toggle_main_menu() {
    if (viewport().width <= window.xs_screen_max) {
        var t = $(".s_navbar .mobile-menu-icon"),
            e = $(".s_navbar .main-menu");
...
function sections_content_vertical_position() {
    if (viewport().width > window.xs_screen_max) {
        var t = $(window).height(),
            e = .8 * t;
        $(".s_main-content .section-wrapper").each(function() {
            var t = $(this).find(".content-wrapper"),
                i = t.height();
            $(this).hasClass("active") ? !0 : !1, i > e ? t.css({
                position: "static"
            }) : t.css({
                position: "absolute"
            })
        })
    } else $(".s_main-content .section-wrapper .content-wrapper").css({
        position: "static"
    })
}
...
function initialise_general_links_click_events() {
    $("a.link-scroll").click(function(t) {
        ...
        if (void 0 === e || "" == e || "#" == e) return t.preventDefault(), !1;
        var i = e.substr(0, 1);
        if ("#" == i) {
            if (!($(e).length > 0)) return !1;
            $(".s_main-content").addClass("same_page_link_in_action");
            var a = $(e).offset().top;
            $("html, body").stop().animate({
                scrollTop: a
            }, 1500, "easeInOutCubic", function() {
                $(".s_main-content").removeClass("same_page_link_in_action"), update_active_sections_on_scroll()
            }), t.preventDefault()
        }
    })
}
...
function initialise_main_menu_click_events() {
    $(".main-menu li a").off("click"), $(".main-menu li a").prop("onclick", null), $(".main-menu li a").click(function(t) {
        var e = $(this).attr("href"),
            i = e.substr(0, 1),
            a = $(this).parent(".main-menu li"),
            n = a.attr("id");
        if (a.hasClass("scroll") && "#" == i) {
            var s = void 0 !== n && "" != n ? n : "";
            $(".s_main-content").addClass("same_page_link_in_action");
            var o = viewport().width > window.xs_screen_max ? !0 : !1;
            scroll_to_section(e, s, o), t.preventDefault()
        } else if (void 0 === e || "" == e || "#" == e) return t.preventDefault(), !1
    })
}

function scroll_to_section(t, e, i) {
    if (void 0 === t || "" == t) return !1;
    var a = $(".s_main-content " + t + ".section-wrapper");
    if (0 == a.length || a.hasClass("active")) return !1;
    var n = a.offset().top;
    $("html, body").stop().animate({
        scrollTop: n
    }, 1500, "easeInOutCubic", function() {
        $(".s_main-content").removeClass("same_page_link_in_action")
    }), set_section_to_active(t, e, "", i)
}

function set_section_to_active(t, e, i, a) {
    if (void 0 !== t && "" != t) {
        var n = $(".s_main-content " + t + ".section-wrapper");
        $(".main-menu .menu-item").removeClass("active"), $(".s_main-content .section-wrapper").removeClass("active");
        var s = void 0 != e && "" != e ? $("#main-menu #" + e + ".menu-item") : "";
        if ("" != s && 0 != s.length) s.addClass("active");
        else {
            var o = t.substr(1);
            $(".main-menu " + o + ".menu-item").addClass("active")
        }
        if (n.addClass("active"), toggle_top_icon_in_main_menu(), 0 != a) {
            var r = n.attr("data-custom-background-img"),
                c = void 0 !== r && "" != r ? r : $("#outer-background-container").attr("data-default-background-img");
            if (void 0 !== c && "" != c) {
                var d = 1 != i ? 1500 : 550;
                $("#outer-background-container").backstretch(c, {
                    fade: d
                })
            }
        }
...
function update_active_sections_on_scroll(t, e) {
    var i = void 0 !== t && "" != t ? t : $("s_main-content").find(".section-wrapper"),
        e = e !== e && "" != e ? e : .25 * $(window).height(),
    ...
    if (void 0 !== n && "" != n) {
        var s = "#" + n.attr("id");
        n.hasClass("active") || set_section_to_active(s, "", !0)
    }
}
...
function toggle_top_icon_in_main_menu() {
    ...
    t.hasClass("active") ? t.css({
        opacity: 0
    }).addClass("main-menu-top-icon-active") : t.css({
        opacity: .7
...
function effect_fade_out_inactive_grid_items() {
    $("#main-content .projects-grid.effect-fade-inactive").length > 0 && $("#main-content .projects-grid.effect-fade-inactive").each(function() {
        ...
        t.find(".grid-item .item-content").hover(function() {
            ...
            e.css({
                opacity: 1
            }), t.find(".grid-item .item-content").not(e).css({
                opacity: .3
            })
        }, function() {
            var t = $(this);
            ...
            setTimeout(function() {
                t.find(".grid-item .item-content").css({
                    opacity: 1
                })
            }, 200)
        })
...
function set_equal_height_to_all_carousel_slides_on_small_displays() {
    ...
    t.each(function() {
        var t = void 0 === $(this).attr("data-height-percent") || "" == $(this).attr("data-height-percent") || isNaN($(this).attr("data-height-percent")) ? 80 : $(this).attr("data-height-percent"),
            e = t / 100 * viewport().height,
            i = $(this).find(".item .carousel-text-content");
        ...
        $(this).find(".item:not(.active)").attr("style", ""), viewport().width <= window.sm_screen_max || n >= e ? ($(this).parents(".section-wrapper").addClass("modified-height"), i.height(n)) : ($(this).parents(".section-wrapper").removeClass("modified-height"), $(this).removeClass("slides-height-modified").find(".item .carousel-text-content").css({
            height: "100%"
        }))
    })
}

function populate_and_open_modal(t, e) {
    var i = $("#common-modal.modal"),
        a = i.find(".modal-body"),
        n = $("#" + e);
    if (a.length > 0 && n.length > 0) {
        $("#outer-container").fadeTo("fast", .2), $(document).scrollTop();
        var s = n.html();
        a.empty().html(s), i.modal(), i.on("shown.bs.modal", function() {
...
function load_images(t, e, a) {
    ...
    if (n.length > 0) {
        ...
        n.each(function() {
            ...
            if (void 0 !== t && "" != t) {
                var e = new Array;
                e.img_object = $(this), e.img_src = t, s.push(e)
            }
        });
        var o = new Image,
            r = s.length;
        for (i = 0; r > i; i++) o.src = s[i].img_src, s[i].img_object.attr("src", s[i].img_src), 1 == e && s[i].img_object.removeClass(t), 1 == a && i == r - 1 && (!jQuery.browser.mobile || viewport().width > window.xs_screen_max) && sections_content_vertical_position()
    }
}
        ...
        t.find(".validate-field").each(function() {
            ...
            return $(this).find(".validate-field").each(function() {
                ...
                success: function(e) {
                    ...
                    var i = "Form submitted successfully." == e ? !0 : !1,
                        a = '<div class="alert ';
                    a += 1 == i ? "success" : "error", a += '">' + e + "</div>", t.find(".form-general-error-container").html(a).fadeIn("fast", function() {
...
function fixed_bg_image_dimensions_on_mobile() {
    ...
    if (t.length > 0) {
        ...
        if (void 0 !== e && "" != e)
            if (jQuery.browser.mobile) $("body").css({
                "background-image": "",
                "background-position": "",
                "background-repeat": "",
                "background-size": "",
                ...
                var i = viewport().height + .1 * viewport().height;
                ...
                a.src = e, $("body").css({
                    ...
                    "background-size": "auto " + i + "px, cover"
                }), t.css({
                    opacity: "0"
                })
            }
...
function contact_form_IE9_placeholder_fix() {
    var t = $("form");
    t.each(function() {
        $(this), $(this).find(".form-control").each(function() {
